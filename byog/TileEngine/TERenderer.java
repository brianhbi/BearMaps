...
public class TERenderer implements Serializable {
    ...
    public void drawText(String text, int fontSize, Color color, int x, int y) {
        Font font = new Font("Monaco", Font.BOLD, fontSize - 2);
        StdDraw.setFont(font);
        StdDraw.setPenColor(color);
        StdDraw.textLeft(x + .5, y + .5, text);
    }
    ...
    public void drawLine(Color color, double thickness, int x1, int y1, int x2, int y2) {
        StdDraw.setPenColor(color);
    ...
    public void drawPic(int x, int y, int w, int h, String filePath) {
        StdDraw.picture(x, y, filePath, w, h);
    }
}
