...
import byog.Core.Utilities.RandomUtils;
...
public class TETile implements Serializable {
    ...
    private final String doubleCharacter;
    ...
    public TETile(char character, Color textColor, Color backgroundColor, String description,
        ...
        this.doubleCharacter = "~";
    }

    public TETile(String character, Color textColor, Color backgroundColor, String description,
                  String filepath) {
        this.character = '~';
        this.textColor = textColor;
        this.backgroundColor = backgroundColor;
        this.description = description;
        this.filepath = filepath;
        this.doubleCharacter = character;
    }
    ...
    public TETile(TETile t, Color textColor, boolean hasDoubleChar) {
        this(t.doubleCharacter, textColor, t.backgroundColor, t.description, t.filepath);
    }


    /**
     * Draws the tile to the screen at location x, y. If a valid filepath is provided,1
    ...
    public void draw(double x, double y) {
        ...
        if (this.character == '~') {
            StdDraw.text(x + 0.5, y + 0.5, doubleCharacter);
        } else {
    ...
    public String getDoubleCharacter() {
        return doubleCharacter;
    }

    public Color getTextColor() {
        return new Color(textColor.getRed(), textColor.getGreen(), textColor.getRed());
    }
        ...
        for (int y = height - 1; y >= 0; y -= 1) {
            for (int x = 0; x < width; x += 1) {
                ...
                if (world[x][y].character() == '~') {
                    sb.append(world[x][y].getDoubleCharacter());
                } else {
